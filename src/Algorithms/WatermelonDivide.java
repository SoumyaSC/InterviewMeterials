...
class WatermelonDivideHelper {
    public String divideMelon(int weight){
        if(weight%2 == 1){
            return "NO";
        }
        else{
...
public class WatermelonDivide{
    public static void main(String []args){
        ...
        WatermelonDivideHelper wd = new WatermelonDivideHelper();
        String result = wd.divideMelon(weight);
